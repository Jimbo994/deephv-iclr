...
typedef struct
{
    ...
    long double **xmin;       /* lower bounds                     */
    long double *xmin_data;   /* lower bounds (one block)         */
    long double **xmax;       /* upper bounds                     */
    long double *xmax_data;   /* upper bounds (one block)         */  
